#' Years of exposure in Portugal by age, sex, and calendar year.
#'
#' The data are from the Human Mortality Database.
#' More recent versions, and a comprehensive description of the data,
